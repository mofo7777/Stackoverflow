...
inline LPCWSTR GetGUIDStringMediaType(const GUID& guid){
	...
	IF_EQUAL_RETURN(guid, MFMediaType_Perception);
	IF_EQUAL_RETURN(guid, MFMediaType_SAMI);
	IF_EQUAL_RETURN(guid, MFMediaType_Script);
	IF_EQUAL_RETURN(guid, MFMediaType_Stream);
	...
	IF_EQUAL_RETURN(guid, MFVideoFormat_v216);
	IF_EQUAL_RETURN(guid, MFVideoFormat_v410);             // MEDIASUBTYPE_V410
	...
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_YUYV);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_Y411);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_Y211);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_RGB8);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_V216);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_mp4v);
	...
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_XVID);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_xvid);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_DIVX);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_divx);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_DX50);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_dx50);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_MSAUDIO1);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_GSM);
	IF_EQUAL_RETURN(guid, MEDIASUBTYPE_IMAADPCMACM);
	...
	IF_EQUAL_RETURN(guid, KSDATAFORMAT_SUBTYPE_ADPCM);
	IF_EQUAL_RETURN(guid, KSDATAFORMAT_SUBTYPE_ALAW);
	IF_EQUAL_RETURN(guid, KSDATAFORMAT_SUBTYPE_DRM);
	IF_EQUAL_RETURN(guid, KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_DIGITAL_PLUS);
	IF_EQUAL_RETURN(guid, KSDATAFORMAT_SUBTYPE_IEC61937_DOLBY_DIGITAL);
	IF_EQUAL_RETURN(guid, KSDATAFORMAT_SUBTYPE_IEEE_FLOAT);
	IF_EQUAL_RETURN(guid, KSDATAFORMAT_SUBTYPE_MPEG);
	IF_EQUAL_RETURN(guid, KSDATAFORMAT_SUBTYPE_MULAW);
	IF_EQUAL_RETURN(guid, KSDATAFORMAT_SUBTYPE_PCM);

	return NULL;
}

inline void LogMediaType(IMFMediaType* pMediaType){
	...
	hr = pMediaType->GetCount(&uiCount);
	...
	if(SUCCEEDED(hr)){
		...
		for(UINT32 i = 0; i < uiCount; i++)
			LogAttributeValueByIndex(pMediaType, i, GetGUIDStringMediaType);

		TRACE((L"\r\n"));
	}
	else{

		TRACE((L"\r\n\tMedia type : no attributes\r\n"));
	}
}
