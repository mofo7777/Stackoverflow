...
// Change the URL : mp4 files seem not to work with this code (ProcessOutput crashes, or there is message MF_SOURCE_READERF_NATIVEMEDIATYPECHANGED).
// However, this wmv file is ok
